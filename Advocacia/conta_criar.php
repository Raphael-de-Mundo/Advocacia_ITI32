...
<body>
<form name="formCadastrar" action="conta_criar_salvar.php" method="post">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>Criar - Conta</h2>
                        <div class="form-group">
                            <label>Numero de OAB</label>
                            <input type="text" class="form-control" required="" placeholder="" name="txtNumOAB">
                        </div>
